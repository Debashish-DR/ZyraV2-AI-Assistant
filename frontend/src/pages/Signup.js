    ...
    >
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          >
            Join us to access your AI assistant
          </motion.p>
        </div>
...
//         <h2 className="text-2xl mb-4 text-center font-bold text-gray-800">Create Account</h2>
...
//        const handleSignup = async () => {
//          try {
//            // Mock signup (replace with actual API if available)
...
//            <h1 className="text-3xl font-bold mb-6 text-center text-blue-600">Zyra V2 Signup</h1>
//            <input
//              type="text"
//              placeholder="Email"
//              value={email}
